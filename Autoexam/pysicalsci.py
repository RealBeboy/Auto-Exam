...
def submit_answers():
    ...
    base_url = "http://122.3.185.245:8081/ROXRUQA/submitprocess.php?submitprocess.php?grade=11&schoolid=1&name=Justine+Roy+P.+Salvador&subject=Science+11PhysicalScience_2nd+Quarter+Final+RUQA.pdf"
